 ...
 * 项目商户变更.
 *
 * 商户添加至余额分账项目后，如需进行变更，可调用此接口进行操作
 */
class MerChangeRequest extends Request
{
    /**
     * 自定义申请单号.
     *
     ...
     * 不传默认 00
     */
    public ?string $balanceLedgerFlag;
    ...
    protected string $uri = '/capital/fundProject/merChange';
     ...
     * 设置是否移出项目.
     */
    public function setCancelFlag(?string $cancelFlag): void
    {
